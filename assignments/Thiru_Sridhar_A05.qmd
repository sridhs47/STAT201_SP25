...
var_pos <- (var_num > 0)
cat("Is the number even?", var_even, "\n")
cat("Is the number positive", var_pos)
...
```{r}
cat((var_even || var_pos) && !(var_pos && var_even))
...
if (minutes == 1 && seconds >1){
  cat(var_seconds, "seconds is", minutes,"minute and", seconds, "seconds")
} else if (minutes==1 && seconds ==1) {
  cat(var_seconds, "seconds is", minutes,"minute and", seconds, "second")
} else if(minutes>1 && seconds ==1){
  cat(var_seconds, "seconds is", minutes,"minute and", seconds, "second")
} else if(minutes>1 && seconds > 1) {
  cat(var_seconds, "seconds is", minutes, "minutes and", seconds, "seconds")
}
...
cat(i, "squared is", i**2, "and is the first number whose square exceeds", object)
```
